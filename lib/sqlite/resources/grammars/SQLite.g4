// Combined SQLite grammar for clj-antlr (merged from SQLiteLexer.g4 and SQLiteParser.g4)
// Original grammars from https://github.com/antlr/grammars-v4/tree/master/sql/sqlite
// MIT License
